...
library(syuzhet) #for sentimennt analysis
...
ggplot(data = sentiment_sums, aes(x = fct_reorder(S_sum, number, .desc = TRUE), y = number, fill = number)) +
  geom_bar(stat = "identity") +
  ylab("Count") +
  xlab("Sentiment") +
  theme_classic()
...
an alternative visualization to word frequency. Then, I undertook two natural 
language processing tasks: Through Latent Dirichlet Allocation, I showed two of
the most salient topics in the data; and, finally, I plotted bi-grams, which
demonstrate strength of relationship between words, and "clusters" where words
concentrate.

The most challennging part of carrying out this project was the handling data
