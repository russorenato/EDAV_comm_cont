...
<!-- (capitol %>%  -->
<!--   group_by(text) %>%  -->
<!--   arrange(desc(capitol$public_metrics$retweet_count)) -->
...
<!--   arrange(desc(public_metrics$retweet_count))) %>%  -->
<!--   ggplot(aes(x = text, y = public_metrics$retweet_count)) + -->
<!--   geom_bar(stat = "identity") + -->
<!--   ylab("Count") + -->
<!--   xlab("Term (stemmed)") + -->
<!--   theme_classic() + -->
...
<!--   arrange(desc(capitol$public_metrics$reply_count)) %>%  -->
<!--   ggplot(aes(x = text, y = capitol$public_metrics$reply_count)) + -->
<!--   geom_bar(stat = "identity") + -->
<!--   ylab("Count") + -->
<!--   xlab("Term (stemmed)") + -->
<!--   theme_classic() -->
...
<!-- capitol %>% -->
<!--   count(capitol$public_metrics$reply_count, text) %>%  -->
<!--   arrange(desc(capitol$public_metrics$retweet_count)) -->
...
<!-- capitol$public_metrics$reply_count -->
<!-- ``` -->
