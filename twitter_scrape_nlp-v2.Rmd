...
load("/Users/renatorusso/Desktop/Ed.D./GR5702/EDAV_comm_cont/capitol.Rda")
```
<!-- The resulting object is composed by columns of lists (e.g., "referenced tweets" -->
<!-- and character data (e.g., "text"). -->
<!-- Now, it is important to save your data set as an easily readable file. In this case, -->
<!-- I'll create a dataframe with the relevant columns and store it it as a Google Drive -->
<!-- spreadsheet, just in case we want to use the data later: -->
<!-- ```{r} -->
<!-- # capitol_dyor_txt <- capitol_dyor %>%  -->
<!-- #   dplyr::select(text) -->
<!-- #  -->
<!-- googlesheets4::gs4_create("capitol_dyor") # create new spreadsheet -->

<!-- googlesheets4::sheet_write(capitol_dyor_txt, ss = "https://docs.google.com/spreadsheets/d/1Ff6ORFeykkALJmZ4gtcOyuOXI1JqnrwgBJ4gc62gWO0/edit#gid=0", -->
<!--                            sheet = "capitol_dyor") -->

<!-- googlesheets4::sheet_write(capitol_dyor, ss = "https://docs.google.com/spreadsheets/d/1Ff6ORFeykkALJmZ4gtcOyuOXI1JqnrwgBJ4gc62gWO0/edit#gid=0", -->
<!--                            sheet = "capitol_dyor") -->
...
wordcloud(words$word, words$n, min.freq = 5,
