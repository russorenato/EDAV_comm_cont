...
tweets <- iconv(capitol$text) # creating a tibble containg the text
...
``` {r}
inner_join(capitol, sentiment, by = "text")

capitol %>% 
  inner_join(sentiment, by = "")
